...
align() {
	...
	bsub -M4000 -n4 -R"span[hosts=1] select[mem>4000] rusage[mem=4000]" -Jalign_"$pre_fn" -oalign_"$pre_fn".o "bwa mem -R "@RD\tID:${pre_fn}\tSM:${pre_fn}" -t4 ${idxbase} ${pre_fn}_1.fq ${pre_fn}_2.fq | samtools view -h -b - | samtools sort - -O BAM -o ${pre_fn}.srt.bam && rm -f ${pre_fn}_[12].fq" & 
