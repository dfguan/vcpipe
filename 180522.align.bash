...
align() {
	...
	bsub -M4000 -n4 -R"span[hosts=1] select[mem>4000] rusage[mem=4000]" -Jalign_"$pre_fn" -oalign_"$pre_fn".o "bwa mem -t4 ${idxbase} ${pre_fn}_1.fq ${pre_fn}_2.fq | samtools sort -O BAM | samtools rmdup - ${pre_fn}.srt.rmdup.bam && rm -f ${pre_fn}_[12].fq"  
